...
import ProblemHeatmap from './profile/ProblemHeatmap.vue'
import api from '../api'
  ...
  <div v-else class="github-profile-page">
    <div class="profile-container">
      ...
      <main class="profile-main">
        ...
        <!-- 做题统计热力图 -->
        <ProblemHeatmap
          :solved-problem-count="solvedProblemCount"
          :total-levels="totalLevels"
          :displayed-cleared-levels="displayedClearedLevels"
          :effective-weekly-goal="effectiveWeeklyGoal"
          :user-points="userStore.points"
        />
