...
'''
text = text.replace('import org.springframework.web.bind.annotation.*;', 'import org.springframework.web.bind.annotation.*;\n' + imports)
...
'''
text = re.sub(r'\s*@Autowired\s*private UserProblemRecordRepository userProblemRecordRepository;', '\n' + inj, text)
